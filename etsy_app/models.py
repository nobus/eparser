...
class Listing(models.Model):
    ...
    item_weight = models.PositiveIntegerField(null=True, blank=True, default=None)
    item_weight_unit = models.CharField(max_length=2)
    item_length = models.PositiveIntegerField(null=True, blank=True, default=None)
    item_width = models.PositiveIntegerField(null=True, blank=True, default=None)
    item_height = models.PositiveIntegerField(null=True, blank=True, default=None)
    ...
    occasion = models.CharField(max_length=3, null=True, blank=True, default=None)
    ...
    language = models.CharField(max_length=8, null=True, blank=True, default=None)
